...
from linkexchange_django.support import platform, convert_request
...
def linkexchange_filter(value, request, autoescape=None):
    ...
    if platform is not None:
        value = platform.content_filter(
                convert_request(request), value)
    ...
    def render(self, context):
        ...
        if platform is not None:
            content = platform.content_filter(
                    convert_request(request), content)
        return content
